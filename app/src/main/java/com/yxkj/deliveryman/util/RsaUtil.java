...
public class RsaUtil {
    ...
    public static String encryptString(String data, String publicKeyString) throws Exception {
        PublicKey publicKey = loadPublicKey(publicKeyString);
        byte[] dataResult = encryptData(data.getBytes(), publicKey);
        String cipherTextBase64 = Base64Utils.encode(dataResult);
