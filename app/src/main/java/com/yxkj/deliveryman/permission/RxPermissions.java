...
package com.yxkj.deliveryman.permission;
...
public class RxPermissions {
    ...
    public ObservableTransformer<Object, Permission> ensureEach(final String... permissions) {
        return new ObservableTransformer<Object, Permission>() {
            @Override
            public ObservableSource<Permission> apply(@io.reactivex.annotations.NonNull Observable<Object> upstream) {
                return request(upstream, permissions);
            }
        };
    }
    ...
    Observable<Permission> request(final Observable<?> trigger, final String... permissions) {
        ...
        return oneOf(trigger, pending(permissions))
                .flatMap(new Function<Object, Observable<Permission>>() {
                    @Override
                    public Observable<Permission> apply(@io.reactivex.annotations.NonNull Object o) throws Exception {
